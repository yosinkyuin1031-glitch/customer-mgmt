      ...
      <div className="max-w-6xl mx-auto px-4 py-4">
        ...
        {loading ? (
          <div className="space-y-3">
            ...
            <div className="bg-blue-50 rounded-lg p-3 animate-pulse flex flex-wrap gap-4">
                ...
                <div key={i} className="bg-white rounded-xl shadow-sm p-3 animate-pulse">
                  ...
                  <div className="grid grid-cols-2 gap-1">
                    {Array.from({ length: 4 }).map((_, j) => (
                      <div key={j} className="bg-gray-50 rounded px-2 py-1 flex justify-between">
              ...
              <table className="text-xs w-full">
                <thead>
                  <tr className="bg-gray-50 border-b">
                    <th className="px-2 py-2"><div className="h-3 w-20 bg-gray-200 rounded animate-pulse" /></th>
                    {Array.from({ length: 4 }).map((_, i) => (
                      <th key={i} className="px-2 py-2"><div className="h-3 w-12 bg-gray-200 rounded animate-pulse ml-auto" /></th>
                    ))}
                    <th className="px-2 py-2"><div className="h-3 w-12 bg-gray-200 rounded animate-pulse ml-auto" /></th>
                  </tr>
                </thead>
                <tbody>
                  {Array.from({ length: 5 }).map((_, i) => (
                    <tr key={i} className="border-b animate-pulse">
                      <td className="px-2 py-1.5"><div className="h-3 w-20 bg-gray-200 rounded" /></td>
                      {Array.from({ length: 4 }).map((_, j) => (
                        <td key={j} className="px-2 py-1.5"><div className="h-3 w-10 bg-gray-200 rounded ml-auto" /></td>
                      ))}
                      <td className="px-2 py-1.5"><div className="h-3 w-12 bg-gray-200 rounded ml-auto" /></td>
                    </tr>
                  ))}
                </tbody>
              </table>

...
const STANDARD_COLUMNS = [
  { column_key: 'furigana', column_label: 'ふりがな', sort_order: 1 },
  { column_key: 'birth_date', column_label: '生年月日', sort_order: 2 },
  { column_key: 'gender', column_label: '性別', sort_order: 3 },
  { column_key: 'chief_complaint', column_label: '症状', sort_order: 4 },
  { column_key: 'referral_source', column_label: '来院経路', sort_order: 5 },
  { column_key: 'line_count', column_label: 'LINE回数', sort_order: 6 },
  { column_key: 'ltv', column_label: 'LTV', sort_order: 7 },
  { column_key: 'last_visit', column_label: '最終来院', sort_order: 8 },
  { column_key: 'days_since', column_label: '経過日数', sort_order: 9 },
]
